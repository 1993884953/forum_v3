...
public class UserController {
    ...
    public JsonResult<Map<String, String>> create(@Valid UserCreateDto userCreateDto, HttpServletRequest request) throws IOException, TimeoutException {
        Map<String, String> data = userService.create(userCreateDto,request);
